...
from app.models.schemas import (
    SearchRequest, SearchResponse, PipelineStepLog
)
...
async def perform_search(request: SearchRequest):
    """Execute the full 8-step PubMed Semantic Search pipeline."""
    ...
    try:
        ...
        scored_articles = embed_and_score_articles(request.query, fetched_articles, vector_store)
        pipeline_logs.append(PipelineStepLog(
            step_number=6,

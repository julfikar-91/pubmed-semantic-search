...
# --------------------------------------------------------------------------
# CONFIG — settings values with med_search defaults
# --------------------------------------------------------------------------
NCBI_EMAIL = getattr(settings, "NCBI_EMAIL", "jhakoyna@example.com")
NCBI_API_KEY = getattr(settings, "NCBI_API_KEY", "")
...
CACHE_TTL_SECONDS = getattr(settings, "CACHE_TTL_SECONDS", 60 * 30)

# --------------------------------------------------------------------------
# LOGGING — log_and_monitor()
# --------------------------------------------------------------------------

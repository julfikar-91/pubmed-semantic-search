...
unique_queries = [
    f"semaglutide weight loss mechanisms {time.time()}",
    f"pembrolizumab overall survival melanoma {time.time()}",
    f"crispr cas9 sickle cell anemia trials {time.time()}",
    f"tirzepatide glycemic control in t2dm {time.time()}"
]

print("\n" + "="*70)
print("LIVE UNCACHED SEARCH LATENCY BENCHMARK (< 2.0s TARGET)")
print("="*70)
